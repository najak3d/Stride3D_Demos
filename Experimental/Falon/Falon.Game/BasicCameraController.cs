...
namespace Falon
{
    ...
    public class BasicCameraController : SyncScript
    {
        ...
        public Vector3 KeyboardMovementSpeed { get; set; } = new Vector3(12.0f);
        ...
        public readonly Vector2 MouseRotationSpeed = new Vector2(7.0f, 3.0f);
        ...
        public override void Update()
        {
            ...
            var cam = this.Entity;
            foreach(var e in this.SceneSystem.SceneInstance.RootScene.Entities)
			{
                if (e.Name.Contains("Directional"))
				{
                    var lc = e.Get<LightComponent>();
                    var lt = lc.Type;
				}
			}
        }
        ...
        private void ProcessInput()
        {
            ...
            // Keyboard and Gamepad based movement
            {
                ...
                float heightFactor = 1 + (float)Math.Pow(Math.Abs((1f + Entity.Transform.Position.Y) / 1f), 0.777);
